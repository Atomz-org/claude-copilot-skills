...
-- Adapts HubSpot to the common unified schema so erp_bi_dim_company can union it.
-- The output columns must match every other source's dim_company adapter exactly, in the
...
-- transposes the data. Diff this against fortnox_erp_bi_dim_company.sql before merging.
