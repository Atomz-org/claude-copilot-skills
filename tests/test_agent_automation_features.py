...
def test_required_agent_commands_and_workflows_exist():
    required_paths = [
        ...
        ".claude/skills/marketplace-portability-patterns/SKILL.md",
        ".claude/skills/dbt-skill/SKILL.md",
        ".claude/skills/senior-analytics-engineer/SKILL.md",
        ...
        "skill-packs/github-skills/.claude/commands/marketplace-portability.md",
        ...
        "skill-packs/github-skills/.claude/skills/marketplace-portability-patterns/SKILL.md",
        "skill-packs/github-skills/.claude-plugin/plugin.json",
        "skill-packs/dbt-skills/.claude-plugin/plugin.json",
        "skill-packs/dbt-skills/.claude/skills/dbt-skill/SKILL.md",
        "skill-packs/dbt-skills/.claude/skills/senior-analytics-engineer/SKILL.md",
